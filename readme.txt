...
ClientHello. По ряду причин IP-адрес плохо подходит для выполнения блокировок 
...
Соединения TLS 1.3 устанавливаются с использованием ESNI. Этому способу отдается 
предпочтение, если программе удалось получить ключи.
...
-sni vk.com
  Строка отсылаемая в поле SNI/ServerName. Параметр не вилияет на соединения 
  с использованием ESNI. Подойдет имя любого популярного сайта или пустая 
  строка (-sni "").
