...
ClientHello. По ряду причин IP-адрес плохо подходит для осуществления блокировок 
...
Однако, протокол TLS вполне допускает вообще не добавлять SNI в клиентский 
...
общаться с сайтом через адрес http://127.0.0.1:56789/
...
-host rutracker.org
  Доменное имя сайта к которому выполняется доступ.
